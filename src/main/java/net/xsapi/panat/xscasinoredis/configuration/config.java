package net.xsapi.panat.xscasinoredis.configuration;
...
public class config {
    ...
    public void loadConfigu() {
        customConfigFile = new File(core.getPlugin().getDataFolder(), fileName);
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            core.getPlugin().saveResource(fileName, false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(core.getPlugin().getDataFolder(), fileName);
